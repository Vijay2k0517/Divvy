...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 relative overflow-hidden bg-dark-950">
      {/* BG Glow */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-accent/[0.06] rounded-full blur-[120px]" />
      <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-accent-blue/[0.04] rounded-full blur-[100px]" />
      ...
      >
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-white/40 mt-2">Sign in to your Divvy AI account</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="flex items-center justify-between text-xs">
              <label className="flex items-center gap-2 text-white/40 cursor-pointer">
                <input type="checkbox" className="rounded bg-white/5 border-white/10 text-accent focus:ring-accent/50 w-3.5 h-3.5" />
                Remember me
              </label>
              <a href="#" className="text-accent-light/70 hover:text-accent-light transition-colors">
                Forgot password?
              </a>
            </div>
          ...
          <p className="text-center text-xs text-white/30 mt-7">
            ...
            <Link to="/signup" className="text-accent-light hover:text-accent-light/80 font-medium transition-colors">
              Sign up
            </Link>
          </p>
        </div>
